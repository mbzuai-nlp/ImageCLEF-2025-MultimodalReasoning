...
# CAPTION_FOLDER = "/home/momina.ahsan/Documents/ExamsV/SmolVLM"
CAPTION_FOLDER = "../captions/Llama-3.2-11B-Vision"
...
def evaluate(dataset_path, model_name):
    ...
    output_file = f"{model_name.split('/')[-1]}_llama_caption_short.json"
